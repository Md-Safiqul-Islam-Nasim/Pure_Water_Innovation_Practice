...
<div class="container ">
  <div class="page-inner " style="margin-top: 100px">
    <div class=" d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
      ...
      <div class="ms-md-auto d-flex justify-content-end py-2 py-md-0">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="flag">
                            <img
                              src="backend/assets/img/flags/id.png"
                              alt="indonesia" />
                          </div>
                        </td>
                        <td>Indonesia</td>
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img
                              src="backend/assets/img/flags/us.png"
                              alt="united states" />
                          </div>
                        </td>
                        <td>USA</td>
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img
                              src="backend/assets/img/flags/au.png"
                              alt="australia" />
                          </div>
                        </td>
                        <td>Australia</td>
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img
                              src="backend/assets/img/flags/ru.png"
                              alt="russia" />
                          </div>
                        </td>
                        <td>Russia</td>
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img
                              src="backend/assets/img/flags/br.png"
                              alt="brazil" />
                          </div>
                        </td>
                        <td>Brasil</td>
          ...
          <div class="card-body">
            ...
            <div class="card-list py-4">
              ...
              <div class="item-list">
                <div class="avatar">
                  <img
                    ...
                    alt="..."
                    class="backend/avatar-img rounded-circle" />
                </div>
                <div class="info-user ms-3">
              ...
              <div class="item-list">
                <div class="avatar">
                  <img
                    src="backend/assets/img/chadengle.jpg"
                    alt="..."
                    class="avatar-img rounded-circle" />
                </div>
                <div class="info-user ms-3">
