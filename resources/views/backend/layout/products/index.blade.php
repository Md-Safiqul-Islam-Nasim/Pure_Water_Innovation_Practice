        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <table class="min-w-full table-auto border-collapse border border-gray-200">
                <thead class="bg-gray-50 border-b border-gray-300">
                    <tr>
                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-600 border-r border-gray-300">Name</th>
                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-600 border-r border-gray-300">Price</th>
                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-600 border-r border-gray-300">Description</th>
                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-600 border-r border-gray-300">Stock</th>
